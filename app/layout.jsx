        ...
        <AuthProvider>
          <header className="">
            ...
            <div className="flex justify-around p-6">
              <div className="flex justify-center gap-2">
                ...
                <span className="text-3xl font-bold font-marienda m-2">
                  Bistro Bliss
                </span>
              </div>
              ...
              <div>
                <Link
                  href="/book"
                  className="border-2 p-2 rounded-3xl border-black mb-2 hover:bg-slate-200">
                  Book A Table
                </Link>
              </div>
            </div>
          ...
          <footer className="bg-slate-700 grid grid-cols-3 text-white justify-center text-center">
            <div className="grid grid-rows-3 p-5">
              ...
              <p style={{ width: "200px" }} className="ml-28">
              ...
              <ul className="flex flex-row justify-center gap-5 mt-5 mr-9">
                <li
                  className="text-3xl bg-red-700 rounded-full p-2 cursor-pointer"
                  style={{ height: "50px" }}>
                  <FaFacebookSquare />
                </li>
                <li
