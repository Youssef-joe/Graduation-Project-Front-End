    ...
    <div>
      ...
      <div className="relative flex justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center flex-col gap-2">
          <h1
            className="text-7xl font-bold text-black font-roboto text-center"
            style={{ maxWidth: "500px" }}>
            Best Food For Your Test
          </h1>
          <p
            className="from-neutral-600 font-serif text-center mt-2"
          ...
          <div className="flex flex-row justify-center gap-5 mt-5">
            <Link
              className="bg-red-800 p-4 rounded-3xl text-white hover:bg-red-600"
              href="/book">
              Book A Table
            </Link>
            <Link
              className="bg-white p-4 rounded-3xl hover:bg-slate-200"
              href="/menu">
              Explore Menu
            </Link>
          </div>
      ...
      {/* Section Two */}
      <div>
        <h1 className="flex justify-center text-center p-4 text-4xl font-bold font-serif">
          Browse Our Menu
        </h1>

        <div className="flex flex-row justify-around text-center m-2 p-2">
          <div className="border grid grid-rows-3 justify-center text-center p-4 m-3 shadow-lg rounded-lg">
            ...
            <p>
              In the era of technology we look into the future with certainty
              and pride for our life.
            </p>
            <a href="/menu" className="text-red-700 font-bold font-mono">
              Explore Menu
            </a>
          </div>
      ...
      <div className="flex justify-around m-3 bg-slate-300 p-10">
        ...
        <div className="mt-3" style={{ width: "500px" }}>
          ...
          <p className="ml-3 font-bold mb-5">
          ...
          <span className="ml-3 flex">
            At our place, we believe that dining is not just about food — it’s
          ...
          <button className="text-center justify-center flex mt-5 ml-7 bg-white border rounded-xl p-3 hover:bg-slate-400 hover:text-white">
            More About Us
          </button>
        </div>
      </div>
      ...
      {/* Section Four */}
      <div className="p-7">
        <h1 className="m-2 p-2 text-4xl">
          We Also Offer Unique Services For Your Events
        </h1>
        <div className="grid grid-cols-4 p-5 gap-3">
          <span className="p-4 shadow-lg rounded-lg">
            <Image
              ...
              height={200}
            />
            <h1 className="text-center font-bold mt-3">Party</h1>
          </span>
          <span className="p-4 shadow-lg rounded-lg">
            <Image
              ...
              height={200}
            />
            <h1 className="text-center font-bold mt-3">Weddings</h1>
          </span>
          <span className="p-4 shadow-lg rounded-lg">
            <Image
              ...
              height={200}
            />
            <h1 className="text-center font-bold mt-3">Catering</h1>
          </span>
          <span className="p-4 shadow-lg rounded-lg">
            <Image
              ...
              height={200}
            />
            <h1 className="text-center font-bold mt-3">Corporate Events</h1>
          </span>
        </div>
      </div>

      {/* Section Five */}
      <footer className="bg-gray-200 p-10 flex justify-center text-black flex-col">
        <h1 className="text-center text-3xl mb-2">Stay Updated!</h1>
        <p className="text-center mb-5">
          Subscribe to our newsletter and receive updates about our events,
        ...
        />
        <button className="bg-red-800 p-3 rounded-lg hover:bg-red-600 text-white font-bold font-roboto">
          Subscribe
        </button>
      </footer>
    </div>
